    ...
    if UserInputEvaluation != -1:
        ...
        for Count in range(0, len(Targets)):
            if Targets[Count] == UserInputEvaluation:
                points = 2
                while not bonus and UserInputEvaluation > 2:
                    if round(UserInputEvaluation ** 0.5, 0) == UserInputEvaluation ** 0.5:
                        points += 2
                        bonus = True
                    if round(UserInputEvaluation ** (1/3), 0) == UserInputEvaluation ** (1/3):
                        points += 3
                        bonus = True
                    if round(UserInputEvaluation ** (1/4), 0) == UserInputEvaluation ** (1/4):
                        points += 4
                        bonus = True
                Score += points
                Targets[Count] = -1
